 ...
 */
describe('URL解析', () => {
  const urlString = "http://localhost/application/visualization/pages/edit?id=12&text=kie80*&$";
  ...
  const result = {
    ...
    host: "localhost",
    hostname: "localhost",
    href: "http://localhost/application/visualization/pages/edit?id=12&text=kie80*&$",
    origin: "http://localhost",
    password: "",
    pathname: "/application/visualization/pages/edit",
    port: "",
    protocol: "http:",
    search: "?id=12&text=kie80*&$",
    searchParams: {
      $: undefined,
      id: '12',
      text: 'kie80*'
